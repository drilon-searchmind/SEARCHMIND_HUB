		...
		<>
			<footer className="border-t border-stroke bg-white dark:border-strokedark dark:bg-blacksection">
				<div className="mx-auto max-w-c-1390 px-4 md:px-8 2xl:px-0">
					{/* <!-- Footer Top --> */}
					<div className="hidden py-20 lg:py-25">
						<div className="hidden flex flex-wrap gap-8 lg:justify-between lg:gap-0">
							<motion.div
								variants={{
									hidden: {
										opacity: 0,
							...
							<div className="flex w-full flex-col gap-8 md:flex-row md:justify-between md:gap-0 lg:w-2/3 xl:w-7/12 hidden">
								<motion.div
									variants={{
										hidden: {
											opacity: 0,
					...
					<div className="flex flex-col flex-wrap items-center justify-center gap-5 border-t border-stroke py-7 dark:border-strokedark lg:flex-row lg:justify-between lg:gap-0">
						<motion.div
							...
							className="animate_top"
						>
							<ul className="flex items-center gap-8 hidden">
								<li>
						...
						>
							<p>
								&copy; {new Date().getFullYear()} Searchmind. All rights reserved
							</p>
						</motion.div>
